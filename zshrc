...
function mk (){
	...
	mkdir $1
	cd $1
	mkdir {scans,data,exploits}
	cd scans
	sudo nmap -sSCV -p- --min-rate="3500" -vvv -n -Pn $2 -oA portScaned
	tmux new -s "$1" -n "Reconocimiento"
}

function fnmap (){
	sudo nmap -sSCV -p- --min-rate=4000 -vvv -n -Pn $1 -oA portScaned
}
